  ...
  const plans: PricingPlan[] = [
    ...
    },
    {
      ...
      features: [
        ...
        { vi: 'Kiểm soát cổng ra vào chuyên nghiệp', en: 'Pro gate access control', included: true },
    ...
    },
    {
      ...
      features: [
        ...
        { vi: 'Phân hệ Trạm cân (Weighbridge)', en: 'Weighbridge module included', included: true },
  ...
  const featureCategories: FeatureCategory[] = [
    ...
    },
    {
      ...
      features: [
        ...
        { nameVi: 'Kiểm soát cổng ra vào (Gate Access Control)', nameEn: 'Gate Access Control', standard: false, professional: true, enterprise: true },
    ...
    },
    {
      ...
      features: [
        ...
        { nameVi: 'Phân hệ Cân xe / Trạm cân (Weighbridge)', nameEn: 'Weighbridge integration', standard: false, professional: false, enterprise: true },
