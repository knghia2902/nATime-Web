      ...
      <div className="flex flex-col justify-between gap-5 sm:flex-row sm:items-start">
        <div>
          <div className="flex flex-wrap items-center gap-2">
            <p className="text-sm font-semibold text-blue-600">Android</p>
          ...
          <h2 className="mt-2 text-2xl font-bold text-foreground">nATime Mobile 1.0.0</h2>
        ...
        <a
          href={APK_URL}
          className="h-fit shrink-0 rounded-md bg-primary px-5 py-3 text-center text-sm font-semibold text-primary-foreground hover:bg-primary/90"
        >
          {vi ? 'Tải APK thử nghiệm' : 'Download preview APK'}
        </a>
      </div>
      <dl className="mt-5 grid gap-3 border-t border-blue-200 pt-5 text-xs text-muted sm:grid-cols-2">
        <div>
          <dt className="font-semibold text-foreground">{vi ? 'Tệp' : 'File'}</dt>
          <dd className="mt-1">app-release.apk · 6.68 MB</dd>
        </div>
        <div>
          <dt className="font-semibold text-foreground">SHA-256</dt>
