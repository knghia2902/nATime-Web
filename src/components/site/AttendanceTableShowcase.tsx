...
export default function AttendanceTableShowcase() {
  ...
  return (
    <div 
      style={{ zoom: 0.84 }}
      className="w-full bg-[#f8fafc] text-slate-800 p-2.5 sm:p-3 select-none font-sans rounded-b-xl text-[8.5px] leading-tight"
    >
      {/* ── 1. Header ── */}
      <div className="flex items-center justify-between gap-2 mb-2">
        ...
        <div className="flex items-center gap-1">
          <button
            type="button"
            className="inline-flex items-center gap-0.5 px-1.5 py-0.5 rounded text-[8px] font-semibold text-white bg-[#4f46e5] hover:bg-[#4338ca] shadow-2xs transition-all active:scale-95 cursor-pointer"
          >
          ...
          <button
            type="button"
            className="inline-flex items-center gap-0.5 px-1.5 py-0.5 rounded text-[8px] font-semibold text-white bg-[#059669] hover:bg-[#047857] shadow-2xs transition-all active:scale-95 cursor-pointer"
          >
      ...
      {/* ── 2. Filter Box ── */}
      <div className="bg-white rounded-lg border border-slate-200/80 p-2 shadow-2xs mb-2">
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-1.5 items-end">
          ...
          <div className="space-y-0.5">
            ...
            <div className="relative">
              <select
                ...
                className="w-full h-5 pl-1.5 pr-4 rounded border border-slate-200 bg-white text-[8px] text-slate-800 font-medium appearance-none focus:outline-none focus:border-indigo-500 cursor-pointer"
              >
          ...
          <div className="space-y-0.5">
            ...
            <div className="relative">
              <input
                ...
                className="w-full h-5 pl-1.5 pr-4 rounded border border-slate-200 bg-white text-[8px] text-slate-800 font-medium focus:outline-none focus:border-indigo-500"
              />
          ...
          <div className="space-y-0.5">
            ...
            <input
              ...
              className="w-full h-5 px-1.5 rounded border border-slate-200 bg-white text-[8px] text-slate-800 font-medium placeholder:text-slate-400 focus:outline-none focus:border-indigo-500"
            />
          </div>
          ...
          <div>
            <button
              type="button"
              className="w-full h-5 inline-flex items-center justify-center gap-0.5 px-1.5 rounded border border-slate-200 bg-slate-50 hover:bg-slate-100 text-[8px] font-semibold text-slate-700 transition-all active:scale-95 cursor-pointer"
            >
              ...
              {filteredRecords.map((r) => (
                ...
                >
                  ...
                  <td className="py-1 px-1.5">
                    <span className="inline-block px-1 py-0.2 rounded text-[7px] font-semibold bg-slate-100 text-slate-700 font-mono border border-slate-200/50">
                      {r.code}
                    </span>
                  </td>
