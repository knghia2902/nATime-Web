  ...
  return (
    <PublicShell locale={locale}>
      ...
      <section className="max-w-6xl mx-auto px-6 py-14 border-t border-white/[0.08]">
        ...
        <div className="max-w-4xl mx-auto glass-panel rounded-2xl shadow-card overflow-hidden border border-white/12">
          <div className="flex items-center gap-1.5 px-4 h-9 border-b border-white/[0.08] bg-white/[0.03]">
