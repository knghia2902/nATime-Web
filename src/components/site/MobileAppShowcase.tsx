...
export default function MobileAppShowcase() {
  ...
  return (
    <div className="w-full flex items-center justify-center p-2 select-none">
      ...
      <div className="relative w-[325px] h-[650px] bg-[#0c1322] rounded-[50px] p-[9px] shadow-[0_30px_90px_-15px_rgba(0,0,0,0.95),0_0_0_1px_rgba(255,255,255,0.18)] ring-1 ring-white/10 flex flex-col justify-between overflow-hidden">
        ...
        <div className="relative w-full h-full bg-[#f8fafc] text-slate-800 rounded-[40px] overflow-hidden flex flex-col justify-between border border-slate-200/90 font-sans shadow-inner isolate">
          ...
          <div className="h-9 bg-transparent flex justify-between items-center px-6 shrink-0 text-slate-900 text-[11px] font-semibold tracking-tight select-none z-30 pt-1">
            ...
            <div className="w-21 h-4.5 rounded-full bg-black flex items-center justify-between px-2 border border-slate-900/40 shadow-xs">
          ...
          <div className="flex-1 overflow-y-auto relative z-10 custom-scrollbar-light pb-4">
            ...
            {activeTab === 'home' && (
              <div className="space-y-3">
                ...
                <div className="bg-gradient-to-b from-sky-100/60 via-slate-50/40 to-transparent px-4.5 pt-2 pb-4 relative">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2.5">
                      {/* Avatar */}
                      <div className="w-11 h-11 rounded-2xl bg-gradient-to-tr from-sky-400 to-indigo-500 p-[1.5px] shadow-sm shadow-sky-500/10 overflow-hidden shrink-0">
                      ...
                      <div>
                        ...
                        <h3 className="font-extrabold text-[14px] leading-tight text-slate-900">
                          Bùi Khắc Nghĩa
                        </h3>
                        <p className="text-[9px] text-sky-600 font-semibold mt-0.5">BP CNTT &bull; 05A00001315</p>
                      </div>
                    </div>
                ...
                <div className="px-3.5 space-y-3 relative z-20">
                  
                  {/* Card HÔM NAY: THỨ SÁU, 21/8 (Pure White, Rounded-3xl, Single Line Header) */}
                  <div className="bg-white rounded-3xl p-3.5 shadow-md border border-slate-200/70 space-y-2.5">
                    {/* Card Header */}
                    <div className="flex items-center justify-between border-b border-slate-100 pb-2">
                      <h4 className="font-bold text-[9.5px] text-slate-800 flex items-center gap-1.5 uppercase tracking-wide whitespace-nowrap">
                        <span className="w-1 h-3 rounded bg-sky-500 shrink-0" />
                        HÔM NAY: THỨ SÁU, 21/8
                      </h4>
                      <span className="px-2 py-0.5 rounded-full text-[7px] font-bold uppercase tracking-wider bg-emerald-500/15 text-emerald-600 border border-emerald-500/20 whitespace-nowrap shrink-0">
                        ĐÃ CHẤM CÔNG
                      </span>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <div className="bg-slate-50/80 p-2.5 rounded-2xl border border-slate-150 shadow-2xs">
                        ...
                        <p className="font-bold text-[10.5px] text-slate-800 mt-0.5 truncate">Hành Chính V...</p>
                        <p className="text-[8px] text-slate-500 mt-0.5 font-medium">08:00 - 17:00</p>
                      </div>

                      <div className="bg-slate-50/80 p-2.5 rounded-2xl border border-slate-150 shadow-2xs">
                        <p className="text-[7.5px] text-slate-400 font-bold uppercase tracking-wider">HOẠT ĐỘNG</p>
                        <p className="font-bold text-[10.5px] text-emerald-600 mt-0.5">Đúng giờ</p>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-2 pt-0.5">
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <p className="font-extrabold text-[10.5px] text-slate-800 font-mono">07:51:02</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <p className="font-extrabold text-[10.5px] text-slate-800 font-mono">--:--</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-1.5">
                    <div className="flex justify-between items-center px-1">
                      <h4 className="font-bold text-[9.5px] text-slate-700 uppercase tracking-wide flex items-center gap-1.5">
                        <span className="w-1 h-3 rounded bg-sky-500 shrink-0" />
                        LỊCH SỬ CÔNG GẦN ĐÂY
                      </h4>
                      <span 
                        onClick={() => setActiveTab('schedule')}
                        className="text-[9px] text-sky-600 font-bold hover:underline cursor-pointer"
                      >
                        Xem thêm
                      </span>
                    </div>
                    ...
                    <div className="bg-white border border-slate-200/80 rounded-3xl overflow-hidden divide-y divide-slate-150 shadow-sm text-[9px]">
                      {/* Row 21/8 */}
                      <div className="p-2 flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          <div className="w-7 h-7 rounded-xl bg-slate-100 text-slate-700 font-bold text-[8px] flex items-center justify-center">
                            21/8
                          </div>
                          <div>
                            <p className="font-bold text-[9.5px] text-slate-800">Hành Chính Văn Phòng</p>
                            <p className="text-[8px] text-slate-400 font-mono">Vào: 07:51:02 | Ra: --</p>
                          </div>
                        </div>
                      ...
                      <div className="p-2 flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            <p className="font-bold text-[9.5px] text-slate-800">Hành Chính Văn Phòng</p>
                            <p className="text-[8px] text-slate-400 font-mono">Vào: 07:55:54 | Ra: 17:20:22</p>
                          </div>
                        </div>
                        <div className="text-right">
                          <span className="text-[8.5px] font-bold text-emerald-600 block">Đúng giờ</span>
                          <span className="text-[7.5px] text-slate-400 font-medium">8.0h công</span>
                        </div>
                      </div>
                      ...
                      <div className="p-2 flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            <p className="font-bold text-[9.5px] text-slate-800">Hành Chính Văn Phòng</p>
                            <p className="text-[8px] text-slate-400 font-mono">Vào: 07:56:21 | Ra: --</p>
                          </div>
                        </div>
                        <div className="text-right">
                      ...
                      <div className="p-2 flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            <p className="font-bold text-[9.5px] text-slate-800">Hành Chính Văn Phòng</p>
                            <p className="text-[8px] text-slate-400 font-mono">Vào: 07:55:01 | Ra: 17:11:45</p>
                          </div>
                        </div>
                        <div className="text-right">
                          <span className="text-[8.5px] font-bold text-emerald-600 block">Đúng giờ</span>
                  ...
                  <div className="space-y-1.5 pb-2">
                    <h4 className="font-bold text-[9.5px] text-slate-700 uppercase tracking-wide flex items-center gap-1.5 px-1">
                      <span className="w-1 h-3 rounded bg-indigo-600 shrink-0" />
                      THIẾT BỊ ĐANG BÀN GIAO (2)
                    </h4>

                    {/* Asset 1 */}
                    <div className="bg-white p-3 rounded-3xl border border-slate-200 shadow-sm flex items-center justify-between hover:border-slate-300 transition-colors">
                      <div className="flex items-center gap-2.5 min-w-0">
                        <div className="w-8.5 h-8.5 rounded-2xl bg-indigo-500/10 text-indigo-600 border border-indigo-500/20 flex items-center justify-center shrink-0">
                          <Desktop size={16} weight="bold" />
                        </div>
                        <div className="min-w-0">
                          <p className="font-bold text-[10px] text-slate-800 truncate">Màn hình máy tính Dell U2424H</p>
                          <p className="text-[8px] text-slate-400 font-semibold truncate">A000001744 &bull; Màn hình</p>
                        </div>
                      </div>
                    ...
                    <div className="bg-white p-3 rounded-3xl border border-slate-200 shadow-sm flex items-center justify-between hover:border-slate-300 transition-colors">
                      <div className="flex items-center gap-2.5 min-w-0">
                        ...
                        <div className="min-w-0">
                          <p className="font-bold text-[10px] text-slate-800 truncate">Máy tính để bàn DELL OptiPlex 3090 To...</p>
                          <p className="text-[8px] text-slate-400 font-semibold truncate">A000000670 &bull; PC</p>
                        </div>
                      </div>
                      <CaretRight size={13} className="text-slate-400 shrink-0" />
                    </div>
            ...
            {activeTab === 'scanner' && (
              <div className="p-3.5 space-y-3.5">
                ...
                <div className="flex items-center justify-between pb-2 border-b border-slate-200">
                  ...
                  <h3 className="text-[10.5px] font-bold tracking-wide uppercase text-slate-800">Quét mã QR thiết bị</h3>
                  <div className="w-5" />
                </div>

                {/* Camera Scanner Viewfinder */}
                <div className="flex flex-col justify-center items-center py-4">
                  <div className="w-[180px] aspect-square rounded-3xl overflow-hidden bg-slate-900 border border-slate-800 relative shadow-lg flex items-center justify-center">
                  ...
                  <p className="text-[9px] text-slate-500 text-center mt-3.5 max-w-[180px] leading-relaxed">
            ...
            {activeTab === 'schedule' && (
              <div className="space-y-3">
                ...
                <div className="bg-gradient-to-b from-sky-100/60 via-slate-50/40 to-transparent px-4.5 pt-2 pb-3 relative">
                  <h3 className="font-extrabold text-[15px] text-slate-900 leading-tight">Lịch làm & Ngày công</h3>
                  <p className="text-[9.5px] text-sky-600 font-semibold mt-0.5">Theo dõi ca làm và giờ công chi tiết hàng tháng</p>
                </div>
                ...
                <div className="px-3.5 space-y-3 relative z-20">
                  ...
                  <div className="flex items-center justify-between px-1">
                    ...
                    <h4 className="font-bold text-slate-700 text-[10px] bg-white px-3.5 py-1 rounded-full border border-slate-200 shadow-xs">
                      Tháng 8 / 2026
                    </h4>
                    <button className="p-1.5 rounded-xl bg-white border border-slate-200 text-slate-500 shadow-xs">
                  ...
                  <div className="grid grid-cols-3 gap-1.5 text-center">
                    {/* Giờ công */}
                    <div className="bg-white border border-slate-200 p-2 rounded-2xl flex flex-col items-center justify-center shadow-xs">
                      <div className="w-6 h-6 rounded-lg bg-sky-500/10 text-sky-600 border border-sky-500/20 flex items-center justify-center mb-0.5">
                        <Clock size={13} weight="bold" />
                      </div>
                      <p className="text-[7px] text-slate-400 font-bold uppercase tracking-wider">GIỜ CÔNG</p>
                      <p className="font-extrabold text-[11px] text-slate-800 mt-0.5">102.2h</p>
                    </div>

                    {/* Ngày công */}
                    <div className="bg-white border border-slate-200 p-2 rounded-2xl flex flex-col items-center justify-center shadow-xs">
                      <div className="w-6 h-6 rounded-lg bg-amber-500/10 text-amber-600 border border-amber-500/20 flex items-center justify-center mb-0.5">
                        <Files size={13} weight="bold" />
                      </div>
                      <p className="text-[7px] text-slate-400 font-bold uppercase tracking-wider">NGÀY CÔNG</p>
                      <p className="font-extrabold text-[11px] text-slate-800 mt-0.5">16 công</p>
                    </div>

                    {/* Tăng ca */}
                    <div className="bg-white border border-slate-200 p-2 rounded-2xl flex flex-col items-center justify-center shadow-xs">
                      <div className="w-6 h-6 rounded-lg bg-violet-500/10 text-violet-600 border border-violet-500/20 flex items-center justify-center mb-0.5">
                        <Plus size={13} weight="bold" />
                      </div>
                      <p className="text-[7px] text-slate-400 font-bold uppercase tracking-wider">TĂNG CA</p>
                      <p className="font-extrabold text-[11px] text-slate-800 mt-0.5">0h</p>
                    </div>

                    {/* Quên công */}
                    <div className="bg-white border border-slate-200 p-2 rounded-2xl flex flex-col items-center justify-center shadow-xs">
                      <div className="w-6 h-6 rounded-lg bg-orange-500/10 text-orange-600 border border-orange-500/20 flex items-center justify-center mb-0.5">
                        <WarningCircle size={13} weight="bold" />
                      </div>
                      <p className="text-[7px] text-slate-400 font-bold uppercase tracking-wider">QUÊN CÔNG</p>
                      <p className="font-extrabold text-[11px] text-slate-800 mt-0.5">4 ngày</p>
                    </div>

                    {/* Muộn / Sớm */}
                    <div className="bg-white border border-slate-200 p-2 rounded-2xl flex flex-col items-center justify-center shadow-xs">
                      <div className="w-6 h-6 rounded-lg bg-rose-500/10 text-rose-600 border border-rose-500/20 flex items-center justify-center mb-0.5">
                        <Warning size={13} weight="bold" />
                      </div>
                      <p className="text-[7px] text-slate-400 font-bold uppercase tracking-wider">MUỘN / SỚM</p>
                      <p className="font-extrabold text-[11px] text-slate-800 mt-0.5">2 ngày</p>
                    </div>

                    {/* Không phép */}
                    <div className="bg-white border border-slate-200 p-2 rounded-2xl flex flex-col items-center justify-center shadow-xs">
                      <div className="w-6 h-6 rounded-lg bg-red-500/10 text-red-600 border border-red-500/20 flex items-center justify-center mb-0.5">
                        <X size={13} weight="bold" />
                      </div>
                      <p className="text-[7px] text-slate-400 font-bold uppercase tracking-wider">KHÔNG PHÉP</p>
                      <p className="font-extrabold text-[11px] text-slate-800 mt-0.5">1 ngày</p>
                    </div>
                  </div>
                  ...
                  <div className="bg-white border border-slate-200 rounded-3xl p-3.5 shadow-sm space-y-2.5">
                    ...
                    <div className="grid grid-cols-7 gap-y-1.5 gap-x-1 text-center">
                      ...
                      {daysInMonth.map((day) => {
                        ...
                        return (
                          ...
                          >
                            <span className="text-[9.5px] font-bold">{day}</span>
                    ...
                    {/* Legend */}
                    <div className="flex justify-between items-center pt-2 border-t border-slate-150 text-[7px] font-bold text-slate-600 uppercase tracking-tight">
                  ...
                  <div className="bg-white rounded-3xl p-3.5 shadow-sm border border-slate-200 space-y-2.5 pb-2">
                    ...
                    {/* Shift Assigned */}
                    <div className="bg-slate-50/80 p-2.5 rounded-2xl border border-slate-150 space-y-0.5">
                      <div className="flex items-center gap-1.5">
                        <div className="w-5.5 h-5.5 rounded-lg bg-indigo-500/10 text-indigo-600 border border-indigo-500/20 flex items-center justify-center shrink-0">
                    ...
                    {/* Actual Times */}
                    <div className="bg-slate-50/80 p-2.5 rounded-2xl border border-slate-150 space-y-1">
                      <div className="flex items-center gap-1.5">
                        <div className="w-5.5 h-5.5 rounded-lg bg-sky-500/10 text-sky-600 border border-sky-500/20 flex items-center justify-center shrink-0">
          ...
          {/* ── 3. Exact iPhone Bottom Navigation Bar (No Overlapping Text, rounded-b-[40px]) ── */}
          <div className="w-full bg-white/95 backdrop-blur-xl border-t border-slate-200/90 pt-1 pb-2 px-4 rounded-b-[40px] flex flex-col items-center z-30 shrink-0 shadow-[0_-4px_16px_rgba(0,0,0,0.03)]">
            
            {/* Tab Items Row */}
            <div className="w-full h-11 flex items-center justify-around relative">
              ...
              {/* Scan Tab (Floating Center QR Button with Glowing Blue Ring - Text positioned cleanly below) */}
              <div 
                onClick={() => setActiveTab('scanner')}
                className="flex flex-col items-center justify-center w-14 relative cursor-pointer"
              >
                <div className="absolute -top-3.5 w-11 h-11 bg-gradient-to-tr from-sky-400 to-indigo-600 rounded-full flex items-center justify-center shadow-md shadow-sky-400/30 border-[3px] border-slate-50 text-white transform active:scale-95 hover:opacity-95 transition-all">
                ...
                <span className={`text-[7.5px] font-bold mt-7.5 ${activeTab === 'scanner' ? 'text-sky-600' : 'text-slate-400'}`}>
                  Quét QR
                </span>
              </div>
            ...
            <div className="w-28 h-1 bg-slate-900 rounded-full shrink-0 mt-0.5" />
          </div>
