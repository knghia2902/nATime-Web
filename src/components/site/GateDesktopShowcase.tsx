      ...
      <div className="flex gap-2.5 items-stretch">
        ...
        <div className="w-[112px] shrink-0 bg-white/70 backdrop-blur-md rounded-lg border border-white/80 p-1.5 flex flex-col justify-between shadow-2xs">
          <div className="space-y-1.5">
            ...
            <div>
              <span className="text-[5.5px] font-bold text-slate-400 uppercase tracking-wider block px-1 mb-1">
                Quản lý vào ra
              </span>
                ...
                {[
                  ...
                  return (
                    <button
                      ...
                      className={`w-full flex items-center gap-1.5 px-1.5 py-0.8 rounded-[3px] text-[7px] font-semibold transition-all cursor-pointer text-left ${
                        isActive
              ...
              <div className="space-y-0.5">
                {[
                  ...
                  return (
                    <div
                      key={item.name}
                      className="flex items-center gap-1.5 px-1.5 py-0.6 rounded-[3px] text-[6.5px] text-slate-500 hover:text-slate-800 cursor-pointer"
                    >
          ...
          {/* Account Card */}
          <div className="bg-white rounded-[3px] border border-slate-200/70 p-1.2 mt-1.5 flex items-center justify-between shadow-2xs">
            <div>
              <p className="font-bold text-[6.8px] text-slate-800 leading-none">Tài khoản mẫu</p>
              <p className="text-[5.2px] text-slate-400 mt-0.5 leading-none">Chế độ trình bày</p>
            </div>
            <button className="px-1.2 py-0.4 rounded-[2px] text-[5.8px] font-semibold text-rose-600 border border-rose-200 bg-rose-50 hover:bg-rose-100 cursor-pointer">
              Thoát
            </button>
          </div>
        </div>
        ...
        {/* Right 8 Lanes Grid */}
        <div className="flex-1 bg-white/40 backdrop-blur-md rounded-lg border border-white/60 p-2 grid grid-cols-4 gap-1.5">
          {/* ══════════════ ROW 1 ══════════════ */}

          {/* ── CARD 01: Đi bộ 01 ── */}
          <div className="bg-white rounded-lg border border-slate-200/80 p-2.2 flex flex-col justify-between shadow-2xs">
            <div>
              ...
              <div className="grid grid-cols-12 gap-1.5 mb-1.5">
                ...
                <div className="col-span-5 bg-slate-100/80 rounded-md border border-slate-200/60 p-1 flex flex-col items-center justify-between text-center min-h-[82px]">
                  ...
                  <div>
                    <span className="text-[5.8px] font-bold text-slate-800 block truncate">Lê Thu Hà</span>
                    <span className="text-[4.8px] text-slate-400 block font-mono">PT-001</span>
                  </div>
                </div>
              </div>
            </div>

            <div className="border-t border-slate-100 pt-1.2 flex items-center justify-between text-[6.2px]">
              <span className="flex items-center gap-1 text-slate-400 font-medium">
                <span className="w-1.2 h-1.2 rounded-full bg-slate-300" />
                Chưa kết nối
              </span>
              <div className="flex gap-0.8">
                <button className="px-1.2 py-0.3 rounded bg-slate-50 hover:bg-slate-100 text-slate-600 border border-slate-200 text-[5.8px] font-medium cursor-pointer">Cho vào</button>
                <button className="px-1.2 py-0.3 rounded bg-slate-50 hover:bg-slate-100 text-slate-600 border border-slate-200 text-[5.8px] font-medium cursor-pointer">Cho ra</button>
                <button className="px-1.2 py-0.3 rounded bg-slate-50 hover:bg-slate-100 text-slate-600 border border-slate-200 text-[5.8px] font-medium cursor-pointer">Mở barie</button>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg border border-slate-200/80 p-2.2 flex flex-col justify-between shadow-2xs">
            <div>
              ...
              <p className="text-[7.2px] font-bold text-slate-800 mb-0.5">Thông tin phương tiện</p>

              <div className="grid grid-cols-12 gap-1 mb-1">
                <div className="col-span-7 space-y-0.6 text-[6.5px]">
                ...
                <div className="col-span-5 bg-slate-100/80 rounded-md border border-slate-200/60 p-0.8 flex flex-col items-center justify-between text-center min-h-[64px]">
                  <div className="my-auto text-center">
                    <span className="text-[5.2px] font-bold text-slate-400 block leading-tight">MẪU</span>
                    <span className="text-[5.2px] font-bold text-slate-400 block leading-tight">FACEID</span>
                  </div>
                  <div>
                    <span className="text-[5.2px] font-bold text-slate-800 block truncate">Bùi Khắc Nghĩa</span>
                    <span className="text-[4.2px] text-slate-400 block font-mono">05A00001315</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-12 gap-1 mb-1">
                ...
                <div className="col-span-5 bg-slate-100/80 rounded-md border border-slate-200/60 p-0.8 flex flex-col items-center justify-between text-center min-h-[64px]">
                  ...
                  <div>
                    <span className="text-[5.2px] font-bold text-slate-800 block truncate">Trần Hải Nam</span>
                    <span className="text-[4.2px] text-slate-400 block font-mono">XM-002</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-12 gap-1 mb-1">
                ...
                <div className="col-span-5 bg-slate-100/80 rounded-md border border-slate-200/60 p-0.8 flex flex-col items-center justify-between text-center min-h-[64px]">
                  ...
                  <div>
                    <span className="text-[5.2px] font-bold text-slate-800 block truncate">Phạm Quốc Bảo</span>
                    <span className="text-[4.2px] text-slate-400 block font-mono">OT-001</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-12 gap-1.5 mb-1.5">
                ...
                <div className="col-span-5 bg-slate-100/80 rounded-md border border-slate-200/60 p-1 flex flex-col items-center justify-between text-center min-h-[82px]">
                  ...
                  <div>
                    <span className="text-[5.8px] font-bold text-slate-800 block truncate">Võ Mai Chi</span>
                    <span className="text-[4.8px] text-slate-400 block font-mono">PT-002</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-12 gap-1 mb-1">
                ...
                <div className="col-span-5 bg-slate-100/80 rounded-md border border-slate-200/60 p-0.8 flex flex-col items-center justify-between text-center min-h-[64px]">
                  ...
                  <div>
                    <span className="text-[5.2px] font-bold text-slate-800 block truncate">Đỗ Thanh Tùng</span>
                    <span className="text-[4.2px] text-slate-400 block font-mono">XM-003</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-12 gap-1 mb-1">
                ...
                <div className="col-span-5 bg-slate-100/80 rounded-md border border-slate-200/60 p-0.8 flex flex-col items-center justify-between text-center min-h-[64px]">
                  ...
                  <div>
                    <span className="text-[5.2px] font-bold text-slate-800 block truncate">Hoàng Gia Huy</span>
                    <span className="text-[4.2px] text-slate-400 block font-mono">XM-004</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-12 gap-1 mb-1">
                ...
                <div className="col-span-5 bg-slate-100/80 rounded-md border border-slate-200/60 p-0.8 flex flex-col items-center justify-between text-center min-h-[64px]">
                  ...
                  <div>
                    <span className="text-[5.2px] font-bold text-slate-800 block truncate">Nguyễn Đức Long</span>
                    <span className="text-[4.2px] text-slate-400 block font-mono">OT-002</span>
                  </div>
                </div>
              </div>
            </div>
