...
export default function GateDesktopShowcase() {
  ...
  return (
    <div 
      style={{ zoom: 0.68 }}
      className="w-full bg-[#dbeafe]/80 text-slate-800 p-3 select-none font-sans rounded-b-[4px] text-[8.5px] leading-tight"
    >
      {/* ── 1. App Top Window Header ── */}
      <div className="flex items-center justify-between px-2 py-1 mb-2.5 border-b border-sky-200/50">
      ...
      <div className="flex gap-2.5">
        {/* Left Slim Sidebar */}
        <div className="w-[110px] shrink-0 bg-white/70 backdrop-blur-md rounded-[3px] border border-white/60 p-1.5 flex flex-col justify-between shadow-2xs">
          <div className="space-y-2">
            {/* Group 1: QUẢN LÝ VÀO RA */}
            <div>
              <span className="text-[6px] font-bold text-slate-400 uppercase tracking-wider block px-1 mb-1">
                Quản lý vào ra
              </span>
                ...
                {[
                  ...
                  return (
                    <button
                      ...
                      className={`w-full flex items-center gap-1 px-1.5 py-1 rounded-[2px] text-[7px] font-semibold transition-all cursor-pointer text-left ${
                        isActive
              ...
              <div className="space-y-0.5">
                {[
                  ...
                  return (
                    <div
                      key={item.name}
                      className="flex items-center gap-1 px-1.5 py-0.5 rounded-[2px] text-[6.5px] text-slate-500 hover:text-slate-800 cursor-pointer"
                    >
          ...
          {/* Account Box */}
          <div className="bg-white/90 rounded-[2px] border border-slate-200/80 p-1.5 mt-2 flex items-center justify-between">
            <div>
              <p className="font-bold text-[7px] text-slate-800 leading-none">Tài khoản mẫu</p>
              <p className="text-[5.5px] text-slate-400 mt-0.5 leading-none">Trình bày</p>
            </div>
            <button className="px-1 py-0.5 rounded-[1.5px] text-[6px] font-semibold text-rose-600 border border-rose-200 bg-rose-50 hover:bg-rose-100 cursor-pointer">
              Thoát
            </button>
          </div>
        </div>
        ...
        <div className="flex-1 grid grid-cols-4 gap-2">
          {/* ── CARD 01: Đi bộ 01 ── */}
          <div className="bg-white/90 backdrop-blur-md rounded-[3px] border border-white/80 p-2.5 flex flex-col justify-between shadow-2xs">
            <div>
              <div className="flex items-center justify-between border-b border-slate-100 pb-1.5 mb-2">
                <div className="flex items-center gap-1">
                  <span className="px-1 py-0.2 rounded-[1.5px] text-[7px] font-bold bg-indigo-100 text-indigo-700">ĐB</span>
              ...
              <div className="grid grid-cols-12 gap-1.5 mb-2">
                <div className="col-span-7 space-y-1 text-[7px]">
                ...
                <div className="col-span-5 bg-slate-100/90 rounded-[2px] border border-slate-200/80 p-1 flex flex-col items-center justify-center text-center">
                  <span className="text-[6px] text-slate-400 font-bold block mb-1">MẪU ẢNH</span>
                  <div className="w-8 h-12 bg-slate-200/80 rounded-[1px] mb-1 flex items-center justify-center text-slate-400 shadow-2xs">
                    <User size={15} weight="duotone" />
                  </div>
                  <span className="text-[6px] font-bold text-slate-700 block truncate">Lê Thu Hà</span>
                  <span className="text-[5px] text-slate-400 block">PT-001</span>
                </div>
              </div>
            </div>

            <div className="border-t border-slate-100 pt-1.5 flex items-center justify-between text-[6.5px]">
              <span className="text-slate-400 font-medium">● Sẵn sàng</span>
              <div className="flex gap-0.5">
                <button className="px-1.5 py-0.5 rounded-[1px] bg-slate-100 hover:bg-slate-200 text-slate-700 border border-slate-200 text-[6px] font-semibold cursor-pointer">Cho vào</button>
                <button className="px-1.5 py-0.5 rounded-[1px] bg-slate-100 hover:bg-slate-200 text-slate-700 border border-slate-200 text-[6px] font-semibold cursor-pointer">Cho ra</button>
                <button className="px-1.5 py-0.5 rounded-[1px] bg-indigo-50 hover:bg-indigo-100 text-indigo-700 border border-indigo-200 text-[6px] font-semibold cursor-pointer">Mở barie</button>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/90 backdrop-blur-md rounded-[3px] border border-white/80 p-2.5 flex flex-col justify-between shadow-2xs">
            <div>
              <div className="flex items-center justify-between border-b border-slate-100 pb-1.5 mb-2">
                <div className="flex items-center gap-1">
                  <span className="px-1 py-0.2 rounded-[1.5px] text-[7px] font-bold bg-sky-100 text-sky-700">XM</span>
                  <span className="font-bold text-[9px] text-slate-800">Xe máy vào 01</span>
                </div>
                <div className="flex items-center gap-0.5 text-slate-400"><File size={8} /><Gear size={8} /></div>
              </div>

              {/* 2 Camera Feeds */}
              <div className="grid grid-cols-2 gap-1 mb-2">
                <div className="h-10 bg-slate-100/90 rounded-[2px] border border-slate-200 flex flex-col items-center justify-center text-[6px] font-bold text-slate-400">
                  MẪU BIỂN SỐ
                </div>
                <div className="h-10 bg-slate-100/90 rounded-[2px] border border-slate-200 flex flex-col items-center justify-center text-[6px] font-bold text-slate-400">
                  MẪU GÓC KHÁC
              ...
              <div className="grid grid-cols-12 gap-1.5 mb-1">
                <div className="col-span-7 space-y-0.8 text-[7px]">
                ...
                <div className="col-span-5 bg-slate-100/90 rounded-[2px] border border-slate-200/80 p-1 flex flex-col items-center justify-center text-center">
                  <span className="text-[6px] text-slate-400 font-bold block mb-0.5">FACEID</span>
                  <div className="w-7 h-9 bg-slate-200/80 rounded-[1px] mb-0.5 flex items-center justify-center text-slate-400 shadow-2xs">
                    <User size={12} weight="duotone" />
                  </div>
                  <span className="text-[5.5px] font-bold text-slate-700 block truncate">Bùi Khắc Nghĩa</span>
                  <span className="text-[4.5px] text-slate-400 block">05A00001315</span>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white/90 backdrop-blur-md rounded-[3px] border border-white/80 p-2.5 flex flex-col justify-between shadow-2xs">
            <div>
              ...
              <div className="grid grid-cols-2 gap-1 mb-2">
                <div className="h-10 bg-slate-100/90 rounded-[2px] border border-slate-200 flex flex-col items-center justify-center text-[6px] font-bold text-slate-400">MẪU BIỂN SỐ</div>
                <div className="h-10 bg-slate-100/90 rounded-[2px] border border-slate-200 flex flex-col items-center justify-center text-[6px] font-bold text-slate-400">MẪU GÓC KHÁC</div>
              </div>
              ...
              <div className="grid grid-cols-12 gap-1.5 mb-1">
                ...
                <div className="col-span-5 bg-slate-100/90 rounded-[2px] border border-slate-200/80 p-1 flex flex-col items-center justify-center text-center">
                  ...
                  <span className="text-[5.5px] font-bold text-slate-700 block truncate">Trần Hải Nam</span>
                  <span className="text-[4.5px] text-slate-400 block">XM-002</span>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white/90 backdrop-blur-md rounded-[3px] border border-white/80 p-2.5 flex flex-col justify-between shadow-2xs">
            <div>
              <div className="flex items-center justify-between border-b border-slate-100 pb-1.5 mb-2">
                <div className="flex items-center gap-1">
                  <span className="px-1 py-0.2 rounded-[1.5px] text-[7px] font-bold bg-amber-100 text-amber-700">OT</span>
              ...
              <div className="grid grid-cols-12 gap-1.5 mb-1">
                ...
                <div className="col-span-5 bg-slate-100/90 rounded-[2px] border border-slate-200/80 p-1 flex flex-col items-center justify-center text-center">
                  ...
                  <span className="text-[5.5px] font-bold text-slate-700 block truncate">Phạm Quốc Bảo</span>
                  <span className="text-[4.5px] text-slate-400 block">OT-001</span>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-12 gap-1.5 mb-2">
                ...
                <div className="col-span-5 bg-slate-100/90 rounded-[2px] border border-slate-200/80 p-1 flex flex-col items-center justify-center text-center">
                  ...
                  <span className="text-[6px] font-bold text-slate-700 block truncate">Võ Mai Chi</span>
                  <span className="text-[5px] text-slate-400 block">PT-002</span>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-12 gap-1.5 mb-1">
                ...
                <div className="col-span-5 bg-slate-100/90 rounded-[2px] border border-slate-200/80 p-1 flex flex-col items-center justify-center text-center">
                  ...
                  <span className="text-[5.5px] font-bold text-slate-700 block truncate">Đỗ Thanh Tùng</span>
                  <span className="text-[4.5px] text-slate-400 block">XM-003</span>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-12 gap-1.5 mb-1">
                ...
                <div className="col-span-5 bg-slate-100/90 rounded-[2px] border border-slate-200/80 p-1 flex flex-col items-center justify-center text-center">
                  ...
                  <span className="text-[5.5px] font-bold text-slate-700 block truncate">Hoàng Gia Huy</span>
                  <span className="text-[4.5px] text-slate-400 block">XM-004</span>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-12 gap-1.5 mb-1">
                ...
                <div className="col-span-5 bg-slate-100/90 rounded-[2px] border border-slate-200/80 p-1 flex flex-col items-center justify-center text-center">
                  ...
                  <span className="text-[5.5px] font-bold text-slate-700 block truncate">Nguyễn Đức Long</span>
                  <span className="text-[4.5px] text-slate-400 block">OT-002</span>
                </div>
              </div>
            </div>
