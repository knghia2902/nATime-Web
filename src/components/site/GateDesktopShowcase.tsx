...
export default function GateDesktopShowcase() {
  return (
    <div className="w-full bg-[#d6e8fa] text-slate-800 select-none font-sans rounded-b-[6px] shadow-inner overflow-hidden">
      <div 
        style={{ zoom: 0.455 }}
        className="w-[1240px] p-3 text-[11.5px] leading-tight"
      >
        {/* ── 1. App Header ── */}
        <div className="flex items-center justify-between px-2.5 py-1.5 mb-2 border-b border-sky-200/60">
        ...
        {/* ── 2. Full-width 8 Lanes Grid (Large & Clear Proportions) ── */}
        <div className="w-full bg-white/50 backdrop-blur-md rounded-[12px] border border-white/70 p-2.5 grid grid-cols-4 gap-2.5">
          {/* ══════════════ ROW 1 ══════════════ */}

          {/* ── CARD 01: Đi bộ 01 ── */}
          <div className="bg-white rounded-[10px] border border-slate-200/80 p-2.5 flex flex-col justify-between shadow-2xs">
            <div>
              <div className="flex items-center justify-between pb-1.5 mb-1.5 border-b border-slate-100">
                <div className="flex items-center gap-1.5">
                  <span className="px-1.5 py-0.2 rounded text-[9.5px] font-bold bg-indigo-100 text-indigo-700">ĐB</span>
                  <span className="font-bold text-[13px] text-slate-900">Đi bộ 01</span>
                </div>
              ...
              <div className="bg-slate-50/70 rounded-[8px] border border-slate-200/60 p-2 my-1 flex gap-2 items-center">
                ...
                <div className="w-[85px] bg-slate-100 rounded-[6px] border border-slate-200/70 p-1.5 flex flex-col items-center justify-between text-center min-h-[116px]">
            ...
            <div>
              <div className="flex items-center justify-between pb-1.5 mb-1.5 border-b border-slate-100">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="font-bold text-[13px] text-slate-900">Xe máy vào 01</span>
                </div>
                <div className="flex items-center gap-1 text-slate-400">
                  <FloppyDisk size={13} className="cursor-pointer hover:text-slate-600" />
                  <Gear size={13} className="cursor-pointer hover:text-slate-600" />
              ...
              <div className="grid grid-cols-2 gap-1.5 mb-1">
                <div className="h-[50px] bg-slate-100 rounded-[6px] border border-slate-200/80 flex flex-col items-center justify-center text-[10px] font-bold text-slate-400 leading-tight">
                  <span>MẪU</span>
                  <span>BIỂN SỐ</span>
                </div>
                <div className="h-[50px] bg-slate-100 rounded-[6px] border border-slate-200/80 flex flex-col items-center justify-center text-[10px] font-bold text-slate-400 leading-tight">
              ...
              {/* Vehicle Info Box */}
              <div className="bg-slate-50/70 rounded-[8px] border border-slate-200/60 p-2 my-1">
                <p className="text-[12px] font-bold text-slate-900 mb-1">Thông tin phương tiện</p>
                <div className="flex gap-2">
                  ...
                  <div className="w-[76px] bg-slate-100 rounded-[5px] border border-slate-200/70 p-1 flex flex-col items-center justify-between text-center min-h-[80px]">
                    <div className="my-auto text-center">
                    ...
                    <div>
                      <span className="text-[9.5px] font-bold text-slate-800 block truncate">Bùi Khắc Nghĩa</span>
          ...
          <div className="bg-white rounded-[10px] border border-slate-200/80 p-2.5 flex flex-col justify-between shadow-2xs">
            <div>
              <div className="flex items-center justify-between pb-1.5 mb-1.5 border-b border-slate-100">
                <div className="flex items-center gap-1.5">
                  <span className="px-1.5 py-0.2 rounded text-[9.5px] font-bold bg-sky-100 text-sky-700">XM</span>
                  <span className="font-bold text-[13px] text-slate-900">Xe máy vào 02</span>
                </div>
                <div className="flex items-center gap-1 text-slate-400">
                  <FloppyDisk size={13} className="cursor-pointer hover:text-slate-600" />
                  <Gear size={13} className="cursor-pointer hover:text-slate-600" />
              ...
              <div className="bg-slate-50/70 rounded-[8px] border border-slate-200/60 p-2 my-1">
                ...
                <div className="flex gap-2">
                  ...
                  <div className="w-[76px] bg-slate-100 rounded-[5px] border border-slate-200/70 p-1 flex flex-col items-center justify-between text-center min-h-[80px]">
                    ...
                    <div>
                      <span className="text-[9.5px] font-bold text-slate-800 block truncate">Trần Hải Nam</span>
            ...
            <div>
              <div className="flex items-center justify-between pb-1.5 mb-1.5 border-b border-slate-100">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="font-bold text-[13px] text-slate-900">Ô tô vào</span>
                </div>
                <div className="flex items-center gap-1 text-slate-400">
                  <FloppyDisk size={13} className="cursor-pointer hover:text-slate-600" />
                  <Gear size={13} className="cursor-pointer hover:text-slate-600" />
              ...
              <div className="bg-slate-50/70 rounded-[8px] border border-slate-200/60 p-2 my-1">
                ...
                <div className="flex gap-2">
                  ...
                  <div className="w-[76px] bg-slate-100 rounded-[5px] border border-slate-200/70 p-1 flex flex-col items-center justify-between text-center min-h-[80px]">
                    ...
                    <div>
                      <span className="text-[9.5px] font-bold text-slate-800 block truncate">Phạm Quốc Bảo</span>
          ...
          <div className="bg-white rounded-[10px] border border-slate-200/80 p-2.5 flex flex-col justify-between shadow-2xs">
            <div>
              <div className="flex items-center justify-between pb-1.5 mb-1.5 border-b border-slate-100">
                <div className="flex items-center gap-1.5">
                  <span className="px-1.5 py-0.2 rounded text-[9.5px] font-bold bg-indigo-100 text-indigo-700">ĐB</span>
                  <span className="font-bold text-[13px] text-slate-900">Đi bộ 02</span>
                </div>
                <div className="flex items-center gap-1 text-slate-400">
                  <FloppyDisk size={13} className="cursor-pointer hover:text-slate-600" />
                  <Gear size={13} className="cursor-pointer hover:text-slate-600" />
          ...
          <div className="bg-white rounded-[10px] border border-slate-200/80 p-2.5 flex flex-col justify-between shadow-2xs">
            <div>
              <div className="flex items-center justify-between pb-1.5 mb-1.5 border-b border-slate-100">
                <div className="flex items-center gap-1.5">
                  <span className="px-1.5 py-0.2 rounded text-[9.5px] font-bold bg-sky-100 text-sky-700">XM</span>
                  <span className="font-bold text-[13px] text-slate-900">Xe máy ra 01</span>
                </div>
                <div className="flex items-center gap-1 text-slate-400">
                  <FloppyDisk size={13} className="cursor-pointer hover:text-slate-600" />
                  <Gear size={13} className="cursor-pointer hover:text-slate-600" />
              ...
              <div className="bg-slate-50/70 rounded-[8px] border border-slate-200/60 p-2 my-1">
                ...
                <div className="flex gap-2">
                  ...
                  <div className="w-[76px] bg-slate-100 rounded-[5px] border border-slate-200/70 p-1 flex flex-col items-center justify-between text-center min-h-[80px]">
                    ...
                    <div>
                      <span className="text-[9.5px] font-bold text-slate-800 block truncate">Đỗ Thanh Tùng</span>
          ...
          <div className="bg-white rounded-[10px] border border-slate-200/80 p-2.5 flex flex-col justify-between shadow-2xs">
            <div>
              <div className="flex items-center justify-between pb-1.5 mb-1.5 border-b border-slate-100">
                <div className="flex items-center gap-1.5">
                  <span className="px-1.5 py-0.2 rounded text-[9.5px] font-bold bg-sky-100 text-sky-700">XM</span>
                  <span className="font-bold text-[13px] text-slate-900">Xe máy ra 02</span>
                </div>
                <div className="flex items-center gap-1 text-slate-400">
                  <FloppyDisk size={13} className="cursor-pointer hover:text-slate-600" />
                  <Gear size={13} className="cursor-pointer hover:text-slate-600" />
              ...
              <div className="bg-slate-50/70 rounded-[8px] border border-slate-200/60 p-2 my-1">
                ...
                <div className="flex gap-2">
                  ...
                  <div className="w-[76px] bg-slate-100 rounded-[5px] border border-slate-200/70 p-1 flex flex-col items-center justify-between text-center min-h-[80px]">
                    ...
                    <div>
                      <span className="text-[9.5px] font-bold text-slate-800 block truncate">Hoàng Gia Huy</span>
          ...
          <div className="bg-white rounded-[10px] border border-slate-200/80 p-2.5 flex flex-col justify-between shadow-2xs">
            <div>
              <div className="flex items-center justify-between pb-1.5 mb-1.5 border-b border-slate-100">
                <div className="flex items-center gap-1.5">
                  <span className="px-1.5 py-0.2 rounded text-[9.5px] font-bold bg-indigo-100 text-indigo-700">OT</span>
                  <span className="font-bold text-[13px] text-slate-900">Ô tô ra</span>
                </div>
                <div className="flex items-center gap-1 text-slate-400">
                  <FloppyDisk size={13} className="cursor-pointer hover:text-slate-600" />
                  <Gear size={13} className="cursor-pointer hover:text-slate-600" />
              ...
              <div className="bg-slate-50/70 rounded-[8px] border border-slate-200/60 p-2 my-1">
                ...
                <div className="flex gap-2">
                  ...
                  <div className="w-[76px] bg-slate-100 rounded-[5px] border border-slate-200/70 p-1 flex flex-col items-center justify-between text-center min-h-[80px]">
                    ...
                    <div>
                      <span className="text-[9.5px] font-bold text-slate-800 block truncate">Nguyễn Đức Long</span>
