...
export default function GateDesktopShowcase() {
  ...
  return (
    <div 
      style={{ zoom: 0.58 }}
      className="w-full bg-[#dbeafe]/80 text-slate-800 p-2 select-none font-sans rounded-b-[4px] text-[8.5px] leading-tight"
    >
      {/* ── 1. App Top Window Header ── */}
      <div className="flex items-center justify-between px-2 py-1 mb-1.5 border-b border-sky-200/50">
      ...
      <div className="grid grid-cols-12 gap-2">
        {/* Left Sidebar */}
        <div className="col-span-3 bg-white/70 backdrop-blur-md rounded-[3px] border border-white/60 p-1.5 flex flex-col justify-between shadow-2xs">
          <div className="space-y-2">
            {/* Group 1: QUẢN LÝ VÀO RA */}
            <div>
              <span className="text-[6.5px] font-bold text-slate-400 uppercase tracking-wider block px-1 mb-1">
                Quản lý vào ra
              </span>
                ...
                {[
                  ...
                  return (
                    <button
                      ...
                      className={`w-full flex items-center gap-1.5 px-1.5 py-1 rounded-[2px] text-[7.5px] font-semibold transition-all cursor-pointer text-left ${
                        isActive
              ...
              <div className="space-y-0.5">
                {[
                  ...
                  return (
                    <div
                      key={item.name}
                      className="flex items-center gap-1.5 px-1.5 py-0.5 rounded-[2px] text-[7px] text-slate-500 hover:text-slate-800 cursor-pointer"
                    >
          ...
          {/* Account Box */}
          <div className="bg-white/90 rounded-[2px] border border-slate-200/80 p-1 mt-2 flex items-center justify-between">
            <div>
              <p className="font-bold text-[7px] text-slate-800">Tài khoản mẫu</p>
              <p className="text-[6px] text-slate-400">Chế độ trình bày</p>
            </div>
            <button className="px-1 py-0.5 rounded-[1.5px] text-[6.5px] font-semibold text-rose-600 border border-rose-200 bg-rose-50 hover:bg-rose-100 cursor-pointer">
              Thoát
            </button>
          </div>
        </div>
        ...
        <div className="col-span-9 grid grid-cols-4 gap-1.5">
          {/* ── CARD 01: Đi bộ 01 ── */}
          <div className="bg-white/90 backdrop-blur-md rounded-[3px] border border-white/80 p-1.5 flex flex-col justify-between shadow-2xs">
            <div>
              ...
              <div className="grid grid-cols-12 gap-1 mb-1">
                ...
                <div className="col-span-5 bg-slate-100 rounded-[2px] border border-slate-200/60 p-0.5 flex flex-col items-center justify-center text-center">
                  <span className="text-[5.5px] text-slate-400 font-bold block mb-0.5">MẪU ẢNH NGƯỜI</span>
                  <div className="w-5 h-6 bg-slate-200 rounded-[1px] mb-0.5" />
                  <span className="text-[5px] font-bold text-slate-700 block truncate">Lê Thu Hà</span>
            ...
            <div className="border-t border-slate-100 pt-1 flex items-center justify-between text-[6px]">
              ...
              <div className="flex gap-0.5">
                <button className="px-0.5 py-0.2 rounded-[1px] bg-slate-100 text-slate-600 border border-slate-200 text-[5.5px]">Cho vào</button>
                <button className="px-0.5 py-0.2 rounded-[1px] bg-slate-100 text-slate-600 border border-slate-200 text-[5.5px]">Cho ra</button>
                <button className="px-0.5 py-0.2 rounded-[1px] bg-indigo-50 text-indigo-600 border border-indigo-200 text-[5.5px]">Mở barie</button>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/90 backdrop-blur-md rounded-[3px] border border-white/80 p-1.5 flex flex-col justify-between shadow-2xs">
            <div>
              ...
              <div className="grid grid-cols-2 gap-1 mb-1">
                <div className="h-6 bg-slate-100 rounded-[2px] border border-slate-200 flex items-center justify-center text-[5.5px] font-bold text-slate-400">
                  MẪU BIỂN SỐ
                </div>
                <div className="h-6 bg-slate-100 rounded-[2px] border border-slate-200 flex items-center justify-center text-[5.5px] font-bold text-slate-400">
                  MẪU GÓC KHÁC
          ...
          <div className="bg-white/90 backdrop-blur-md rounded-[3px] border border-white/80 p-1.5 flex flex-col justify-between shadow-2xs">
            <div>
              ...
              <div className="grid grid-cols-2 gap-1 mb-1">
                <div className="h-6 bg-slate-100 rounded-[2px] border border-slate-200 flex items-center justify-center text-[5.5px] font-bold text-slate-400">MẪU BIỂN SỐ</div>
                <div className="h-6 bg-slate-100 rounded-[2px] border border-slate-200 flex items-center justify-center text-[5.5px] font-bold text-slate-400">MẪU GÓC KHÁC</div>
              </div>
          ...
          <div className="bg-white/90 backdrop-blur-md rounded-[3px] border border-white/80 p-1.5 flex flex-col justify-between shadow-2xs">
            <div>
              ...
              <div className="grid grid-cols-12 gap-1 mb-1">
                ...
                <div className="col-span-5 bg-slate-100 rounded-[2px] border border-slate-200/60 p-0.5 flex flex-col items-center justify-center text-center">
                  <span className="text-[5.5px] text-slate-400 font-bold block mb-0.5">MẪU ẢNH</span>
                  <div className="w-5 h-6 bg-slate-200 rounded-[1px] mb-0.5" />
                  <span className="text-[5px] font-bold text-slate-700 block truncate">Võ Mai Chi</span>
