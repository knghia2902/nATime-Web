            ...
            <div className="lg:col-span-7 flex justify-center w-full">
              {previewTabs[activePreviewTab].image === '/screenshots/mobile.png' ? (
                <div className="flex items-center justify-center gap-2 sm:gap-4 py-4 w-full overflow-hidden select-none">
                  {/* Phone 1: Calendar */}
                  <div className="hidden sm:block max-w-[130px] md:max-w-[150px] w-full relative overflow-hidden rounded-[24px] border-[4px] border-slate-800 bg-background shadow-lg rotate-[-4deg] -mr-6 opacity-80 hover:opacity-100 hover:rotate-0 hover:scale-[1.05] hover:z-20 transition-all duration-300 cursor-pointer font-sans">
                  ...
                  {/* Phone 2: Main Home */}
                  <div className="max-w-[160px] md:max-w-[180px] w-full relative overflow-hidden rounded-[28px] border-[4px] border-slate-800 bg-background shadow-2xl z-10 hover:scale-[1.05] transition-all duration-300 cursor-pointer font-sans">
                  ...
                  {/* Phone 3: Details */}
                  <div className="hidden sm:block max-w-[130px] md:max-w-[150px] w-full relative overflow-hidden rounded-[24px] border-[4px] border-slate-800 bg-background shadow-lg rotate-[4deg] -ml-6 opacity-80 hover:opacity-100 hover:rotate-0 hover:scale-[1.05] hover:z-20 transition-all duration-300 cursor-pointer font-sans">
